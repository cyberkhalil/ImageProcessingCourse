...
close;clear;
%% gui code
figure('Name','HomeWork 4','Position',[400 100 600 500]);
...
uicontrol('Position',[110 5 120 40],"String","Question 2 A","CallBack",{@Question2_A});
uicontrol('Position',[250 5 120 40],"String","Question 2 B","CallBack",{@Question2_B});
uicontrol('Position',[390 5 120 40],"String","Question 3","CallBack",{@Question3});
